...
Compares the READMEs of 2 to 10 public repositories and scores each pair on how composable or redundant they are. Based on that, you can copy data from existing repos to build new repos.
